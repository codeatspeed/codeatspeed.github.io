...
- Task 10: complete — base-aware Pages static server, real Chromium deployment-path/import smoke, minimal single-token EPUB fixture, and GitHub Pages workflow commits `83ede25`, `f903b43`, `3d61b1f`; root/project production builds, metadata verifiers, protocol checks, and both Pages-path smoke modes pass.
...
- Storage-fallback playback test stabilization: paused synchronously before dismissing the notice and asserting the initial word, commit `3bb5fc9`; focused fallback test passes.
